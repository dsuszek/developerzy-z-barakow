  ...
  describe('validateJobRole', () => {
    it('expect too long name', () => {
      ...
      expect(jobRoleValidator.validateJobRole(jobRole as JobRole)).to.be.equal(
        'Length of name of job role greater than 50 characters!',
      );
    });
    ...
    it('expect too long description', () => {
      ...
      expect(jobRoleValidator.validateJobRole(jobRole as JobRole)).to.be.equal(
        'Length of description of job role greater than 3000 characters!',
      );
    });
...
<<<<<<< HEAD
      expect(jobRoleValidator.validateJobRole(jobRole as JobRole)).to.be.equal(
        'Length of link to job role greater than 1000 characters!',
      );
=======
...
>>>>>>> a313fe4c91fdbc187135e7e8ff63e19d0e91569f
    });
    ...
    it('expect empty description', () => {
      ...
      expect(jobRoleValidator.validateJobRole(jobRole as JobRole)).to.be.equal(
        'Description of job role cannot be empty!',
      );
    });
